...
* **api:** api update ([c0f13f3](https://github.com/Benchify/formalize-python/commit/c0f13f3872adaafabdb9cb0f3f604ba45d2cb6b1))
...
* **internal/types:** support eagerly validating pydantic iterators ([ca833cf](https://github.com/Benchify/formalize-python/commit/ca833cf28124b1d0c97d182ab27cd8322f6d7f69))
...
* **stlc:** configurable CI runner and private-production-repo support in workflow templates ([d2efe59](https://github.com/Benchify/formalize-python/commit/d2efe591008d03310e9491eb10958bed332693c0))
...
* **auth:** prioritize first auth header ([8b81657](https://github.com/Benchify/formalize-python/commit/8b816571cafdb342eccde77d35005ddd8e60afb8))
* **client:** add missing f-string prefix in file type error message ([fd7ef5e](https://github.com/Benchify/formalize-python/commit/fd7ef5e7924ac124eb459d98cc0e023524009f10))
...
* **internal:** resolve build failures ([5633887](https://github.com/Benchify/formalize-python/commit/563388732c8418de9c516f2339d6ed2787131823))
