...
class Formalize(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        if base_url is None:
            base_url = os.environ.get("FORMALIZE_BASE_URL")
        if base_url is None:
    ...
    def with_raw_response(self) -> FormalizeWithRawResponse:
        return FormalizeWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> FormalizeWithStreamedResponse:
        return FormalizeWithStreamedResponse(self)
...
class AsyncFormalize(AsyncAPIClient):
    ...
    @cached_property
    def with_streaming_response(self) -> AsyncFormalizeWithStreamedResponse:
        return AsyncFormalizeWithStreamedResponse(self)
...
class FormalizeWithRawResponse:
    _client: Formalize

    def __init__(self, client: Formalize) -> None:
        self._client = client
...
class AsyncFormalizeWithRawResponse:
    ...
    def __init__(self, client: AsyncFormalize) -> None:
        self._client = client
